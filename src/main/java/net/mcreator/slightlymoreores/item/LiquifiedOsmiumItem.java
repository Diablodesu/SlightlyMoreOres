...
public class LiquifiedOsmiumItem extends BucketItem {
	public LiquifiedOsmiumItem() {
		super(SlightlymoreoresModFluids.LIQUIFIED_OSMIUM, new Item.Properties().craftRemainder(Items.BUCKET).stacksTo(1).rarity(Rarity.COMMON).tab(CreativeModeTab.TAB_MISC));
	}
}
