package dev.diablodesu.slightlymoreores;
...
public class SlightlymoreoresMod {
	public static final Logger LOGGER = LogManager.getLogger(SlightlymoreoresMod.class);
