...
public class SlightlymoreoresModTabs {
	...
	public static final RegistryObject<CreativeModeTab> SMO_TOOLS = REGISTRY.register("smo_tools",
			() -> CreativeModeTab.builder().title(Component.translatable("item_group.slightlymoreores.smo_tools")).icon(() -> new ItemStack(SlightlymoreoresModItems.EMERALD_PICKAXE.get())).displayItems((parameters, tabData) -> {
				...
				tabData.accept(SlightlymoreoresModItems.EMERALD_HOE.get());
					...
					.build());
	public static final RegistryObject<CreativeModeTab> SMO_WEAPONS = REGISTRY.register("smo_weapons",
			() -> CreativeModeTab.builder().title(Component.translatable("item_group.slightlymoreores.smo_weapons")).icon(() -> new ItemStack(SlightlymoreoresModItems.RUBY_SWORD.get())).displayItems((parameters, tabData) -> {
