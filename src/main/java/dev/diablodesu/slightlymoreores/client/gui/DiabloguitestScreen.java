package dev.diablodesu.slightlymoreores.client.gui;
...
public class DiabloguitestScreen extends AbstractContainerScreen<DiabloguitestMenu> {
	private final static HashMap<String, Object> guistate = DiabloguitestMenu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;
	Button button_example_button;

	public DiabloguitestScreen(DiabloguitestMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("slightlymoreores:textures/screens/diabloguitest.png");
